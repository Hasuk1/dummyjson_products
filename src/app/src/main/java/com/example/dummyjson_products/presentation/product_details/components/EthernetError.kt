...
import com.example.dummyjson_products.presentation.product_details.ProductDetailViewModel

@Composable
fun EthernetError(viewModel: ProductDetailViewModel = hiltViewModel()) {
